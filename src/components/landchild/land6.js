...
import Image11 from '../../images/land_plots images/land6.1.jpg';
import Image12 from '../../images/land_plots images/land6.2.jpg';
import Image13 from '../../images/land_plots images/land6.3.jpg';
    ...
    return (
      <div>
        ...
        <div className="flux_div_land">
          ...
          <h1 className="detail card-title">RS 600,50,000  <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text">300 Sq yards Excellent Location Plot available in F-15 IZXB.</p>
          <p className="card-text"><small>F-15, Sindh, Sindh Capital Territory</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Gulammahmoodmalik512</h5>
