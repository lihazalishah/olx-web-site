...
import Image11 from '../../images/land_plots images/land4.1.jpg';
import Image12 from '../../images/land_plots images/land4.2.jpg';
import Image13 from '../../images/land_plots images/land4.3.jpg';
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Type :  Resedental , play Area .</p>
              <p className="card-text">Area : 500 sq-yard.</p>
              <p className="card-text"><small className="text-muted">
                <hr />
                <h5 className="card-title">Description</h5>
                <ul>
                  <li > Dimensions of the Plot: 30 x 90 (500 Sq yards).</li>
                  ...
                  <li > Its 3rd Plot from 700 Feet wide double road.</li>
          ...
          <h1 className="detail card-title">RS 850,85,850  <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text">500 Sq yards Excellent Location Plot available in DHA Lahore.</p>
          <p className="card-text"><small>DHA Lahore, Lahore, Green city of pakistan.</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />SalmanKhank962</h5>
