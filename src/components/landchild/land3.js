...
import Image11 from '../../images/land_plots images/land3.1.jpg';
import Image12 from '../../images/land_plots images/land3.2.jpg';
import Image13 from '../../images/land_plots images/land3.3.jpg';
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Type :  Play Area.</p>
              <p className="card-text">Area : 2000 sq-feet.</p>
              <p className="card-text"><small className="text-muted">
                <hr />
                <h5 className="card-title">Description</h5>
                <ul>
                  <li > Dimensions of the Plot: 200 x 90 (2000 Sq yards).</li>
          ...
          <h1 className="detail card-title">RS 900,50,000  <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text">2000 Sq yards Excellent Location Plot available in H-10 SBSB.</p>
          <p className="card-text"><small>H-10, karachi, Defance Territory</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />ShanKhan473</h5>
