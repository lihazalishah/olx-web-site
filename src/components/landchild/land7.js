...
import Image11 from '../../images/land_plots images/land7.1.jpg';
import Image12 from '../../images/land_plots images/land7.2.JPG';
import Image13 from '../../images/land_plots images/land7.3.jpg';
...
class Land7 extends React.Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Area : 380 sq-yard.</p>
              <p className="card-text"><small className="text-muted">
                <hr />
                <h5 className="card-title">Description</h5>
                <ul>
                  <li > Dimensions of the Plot: 300 x 100 (380 Sq yards).</li>
          ...
          <h1 className="detail card-title">RS 800,50,000  <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text">380 Sq yards Excellent Location Plot available in Godrej Garden City Ahmedabad.</p>
          <p className="card-text"><small>1 BHK Apartment For Sale in Godrej Garden City Ahmedabad</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />DanishHassan302</h5>
