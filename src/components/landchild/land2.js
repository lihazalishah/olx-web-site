...
import Image11 from '../../images/land_plots images/land2.1.jpg';
import Image12 from '../../images/land_plots images/land2.2.jpeg';
import Image13 from '../../images/land_plots images/land2.3.jpg';
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Type : UnderConstruction.</p>
              <p className="card-text">Area : 1000 sq-feet.</p>
              <p className="card-text"><small className="text-muted">
                <hr />
                <h5 className="card-title">Description</h5>
                <ul>
                  <li > Dimensions of the Plot: 90 x 90 (1000 Sq yards).</li>
                  ...
                  <li > Its 2rd Plot from 1000 Feet wide double road.</li>
          ...
          <h1 className="detail card-title">RS 500,00,000  <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text">1000 Sq yards Excellent Location Plot available in G-20 IBBS.</p>
          <p className="card-text"><small>G-20, Islamabad, Islamabad Capital Territory</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />ShahidKhan453</h5>
