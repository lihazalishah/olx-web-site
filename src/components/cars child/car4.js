...
import Car11 from '../../images/cars images/car4.1.webp';
import Car12 from '../../images/cars images/car4.2.webp';
import Car13 from '../../images/cars images/car4.3.webp';
    ...
    return (
      <div>
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div id="carouselExampleSlidesOnly" className="carousel slide container-sm" data-ride="carousel">
              <div className="carousel-inner">
                ...
                <div className="carousel-item">
                  <img style={{ height: "350px" }} src={Car13} className="d-block mt-2 w-100" alt="..." />
                </div>
              </div>
            </div>
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">KMs driven : 20,000 km</p>
              <p className="card-text">Year : 2016</p>
          ...
          <h1 className="detail card-title">PKR 20.3lac<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text">Car </p>
          <p className="card-text"><small>A-15, Islamabad, Islamabad Capital Territory</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Hasnain587</h5>
