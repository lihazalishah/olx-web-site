...
import Car11 from '../../images/cars images/car2.1.webp';
import Car12 from '../../images/cars images/car2.2.png';
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">KMs driven : 30,000 km</p>
              <p className="card-text">Year : 2010</p>
          ...
          <h1 className="detail card-title">PKR 82.8lac<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Usama787</h5>
