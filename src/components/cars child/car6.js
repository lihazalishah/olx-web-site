...
import Car11 from '../../images/cars images/car6.1.webp';
import Car12 from '../../images/cars images/car6.2.webp';
import Car13 from '../../images/cars images/car6.3.webp';
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Fuel : CNG</p>
              <p className="card-text">KMs driven : 25,000 km</p>
              <p className="card-text">Year : 2014</p>
          ...
          <h1 className="detail card-title">PKR 30lac<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Noman887</h5>
