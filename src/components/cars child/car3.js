...
import Car11 from '../../images/cars images/car3.1.webp';
import Car12 from '../../images/cars images/car3.2.webp';
import Car13 from '../../images/cars images/car3.3.webp';
    ...
    return (
      <div>
        ...
        <div className="flux_div_land">
          ...
          <h1 className="detail card-title">PKR 50.3lac<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Adeel787</h5>
