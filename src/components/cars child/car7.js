...
import Car11 from '../../images/cars images/car7.1.png';
import Car12 from '../../images/cars images/car7.2.png';
import Car13 from '../../images/cars images/car7.3.jpg';
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">KMs driven : 50,000 km</p>
          ...
          <h1 className="detail card-title">PKR 28lac<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Ikrar787</h5>
