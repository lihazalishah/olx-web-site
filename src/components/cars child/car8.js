...
import Car11 from '../../images/cars images/car8.1.png';
import Car12 from '../../images/cars images/car8.2.jpg';
import Car13 from '../../images/cars images/car8.3.jpg';
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div id="carouselExampleSlidesOnly" className="carousel slide container-sm" data-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active ">
                  <img type="wave"  style={{ height: "350px" }} src={Car11} className="d-block mt-2 w-100" alt="Img" />
                </div>
                <div className="carousel-item">
                  <img style={{ height: "350px" }} src={Car12} className="d-block mt-2 w-100" alt="Img" />
                </div>
                <div className="carousel-item">
                  <img style={{ height: "350px" }} src={Car13} className="d-block mt-2 w-100" alt="Img" />
                </div>
              </div>
            </div>
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Fuel : Multi</p>
              <p className="card-text">KMs driven : 45,000 km</p>
          ...
          <h1 className="detail card-title">PKR 18lac<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Mubeen787</h5>
