...
import Car11 from '../../images/cars images/car5.1.webp';
import Car12 from '../../images/cars images/car5.2.webp';
import Car13 from '../../images/cars images/car5.3.webp';
    ...
    return (
      <div>
        ...
        <div className="flux_div_land">
          ...
          <h1 className="detail card-title">PKR 25.7lac<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text">Car </p>
          <p className="card-text"><small>H-10, Multan,Mulatn Capital Territory</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Raja787</h5>
