...
import Mobile11 from '../../images/Mobile_ phones images/mobile3.1.png';
import Mobile12 from '../../images/Mobile_ phones images/mobile3.2.png';
import Mobile13 from '../../images/Mobile_ phones images/mobile3.3.png';
...
class Mobile3 extends React.Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Make : oppo</p>
              <p className="card-text">Condition : New</p>
              <p className="card-text"><small className="text-muted">
                <hr />
                <h5 className="card-title">Description</h5>
                <ul>
                  <li > Display : 6.43-inch (1080x2400)</li>
                  <li > Processor : MediaTek Helio P95</li>
                  <li > Front Camera : 16MP + 2MP</li>
                  <li > Rear Camera : 48MP + 8MP + 2MP + 2MP</li>
                  <li > RAM : 8GB</li>
                  <li > Storage : 128GB</li>
          ...
          <h1 className="detail card-title">RS 50,000  <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text">oppo A5 </p>
          <p className="card-text"><small>G-20, karachi, Karachi Defence Territory</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />babubhai362</h5>
