...
import Mobile11 from '../../images/Mobile_ phones images/mobile4.1.png';
import Mobile12 from '../../images/Mobile_ phones images/mobile4.2.jpg';
import Mobile13 from '../../images/Mobile_ phones images/mobile4.3.png';
...
class Mobile4 extends React.Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Make : Samsung Glaxy</p>
              ...
              <p className="card-text"><small className="text-muted">
                ...
                <ul>
                  ...
                  <li > Processor : Samsung Exynos 9611</li>
          ...
          <h1 className="detail card-title">RS 20,000  <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text">Samsung Galaxy </p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />BilalKhan602</h5>
