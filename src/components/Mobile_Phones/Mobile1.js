...
import Mobile11 from '../../images/Mobile_ phones images/mobile2.1.webp';
import Mobile12 from '../../images/Mobile_ phones images/mobile2.2.webp';
import Mobile13 from '../../images/Mobile_ phones images/mobile2.3.webp';
    ...
    return (
      <div>
        ...
        <div className="flux_div_land">
          ...
          <h1 className="detail card-title">RS 29,999  <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Sohail362</h5>
