...
import Mobile11 from '../../images/Mobile_ phones images/mobile8.1.png';
import Mobile12 from '../../images/Mobile_ phones images/mobile8.2.png';
import Mobile13 from '../../images/Mobile_ phones images/mobile8.3.webp';
...
class Mobile8 extends React.Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Make : Huwae</p>
              ...
              <p className="card-text"><small className="text-muted">
                ...
                <ul>
                  ...
                  <li > Processor : Huwaee9611</li>
                  <li > Front Camera : 32MP</li>
                  <li > Rear Camera : 64MP + 8MP + 5MP</li>
                  <li > RAM : 6GB</li>
                  <li > Storage : 64GB</li>
          ...
          <h1 className="detail card-title">RS 18,000  <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text">Huwaee </p>
          <p className="card-text"><small>H-20,Islamabad, Islamabad Capital Territory</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />UmairKhan602</h5>
