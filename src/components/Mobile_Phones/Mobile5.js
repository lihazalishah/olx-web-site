...
import Mobile11 from '../../images/Mobile_ phones images/mobile5.1.png';
import Mobile12 from '../../images/Mobile_ phones images/mobile5.2.png';
import Mobile13 from '../../images/Mobile_ phones images/mobile5.3.webp';
...
class Mobile5 extends React.Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div className="flux_div_land">
          ...
          <h1 className="detail card-title">RS 23,000  <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />AliHassan687</h5>
