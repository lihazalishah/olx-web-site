...
import House11 from '../../images/Houses images/house1.1.png';
import House12 from '../../images/Houses images/house1.2.jpg';
import House13 from '../../images/Houses images/house1.3.jpeg';
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Bedrooms : 6+</p>
              <p className="card-text">Bathrooms : 7+</p>
              ...
              <p className="card-text"><small className="text-muted">
                ...
                <ul>
                  ...
                  <li>Quality Check By Bahria</li>
                  <li>Details :</li>
                  <li>Bahria phase 3</li>
                  <li>Master Bed ROOMS 6</li>
                  <li>Washroom 7</li>
                  <li>2 TV launch</li>
                  <li>Powder room</li>
                  <li >Servant quarter</li>
                  <li >Decorated lawn.</li>
                  <li>Only Serious Buyer Contact With Us</li>
                  <li>Dealers Can't be Find This</li>
                  <li>Climate control</li>
                  <li>Contact With Direct Owner</li>
                  <li>Demand 5 Crore</li>
                  <li>Offer Required</li>
                  <li>Sale by Urgent</li>
                  <li>Decorated lawn.</li>
          ...
          <h1 className="detail card-title">Rs 50,000,000<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text"> House </p>
          <p className="card-text"><small>Bahria Town, Islamabad, Islamabad Capital Territory</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Malik Group</h5>
