...
import House11 from '../../images/Houses images/house3.1.png';
import House12 from '../../images/Houses images/house3.2.jpg';
import House13 from '../../images/Houses images/house3.3.jpg';
    ...
    return (
      <div>
        ...
        <div className="flux_div_land">
          ...
          <h1 className="detail card-title">Rs 55,000,000<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Zaeem Group</h5>
