...
import House11 from '../../images/Houses images/house5.1.jpg';
import House12 from '../../images/Houses images/house5.2.webp';
import House13 from '../../images/Houses images/house5.3.jpg';
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Area unit : Square Yards</p>
          ...
          <h1 className="detail card-title">Rs 60,000,000<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Bilal Group</h5>
