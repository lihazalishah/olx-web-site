...
import House11 from '../../images/Houses images/house7.1.jpg';
import House12 from '../../images/Houses images/house7.2.jpg';
import House13 from '../../images/Houses images/house7.3.jpg';
...
class House7 extends React.Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Bedrooms : 2</p>
              <p className="card-text">Bathrooms : 3+</p>
              <p className="card-text">Area unit : Square Feet</p>
          ...
          <h1 className="detail card-title">Rs 28,000,000<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text"> House </p>
          <p className="card-text"><small>Main peco road near Akber chowk Township karachi</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Faizan Group</h5>
