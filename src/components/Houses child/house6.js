...
import House11 from '../../images/Houses images/house6.1.jpg';
import House12 from '../../images/Houses images/house6.2.jpg';
import House13 from '../../images/Houses images/house6.3.png';
...
class House6 extends React.Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div id="carouselExampleSlidesOnly" className="carousel slide container-sm" data-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active ">
                  <img   style={{ height: "350px" }} src={House11} className="d-block mt-2 w-100" alt="Img" />
                </div>
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Bedrooms : 3</p>
              <p className="card-text">Bathrooms : 5+</p>
              <p className="card-text">Area unit : Square Yard</p>
          ...
          <h1 className="detail card-title">Rs 58,000,000<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Irfan Group</h5>
