...
import Tv11 from '../../images/Tv_Audio_Video images/tv5.1.png'
import Tv12 from '../../images/Tv_Audio_Video images/tv5.2.png'
import Tv13 from '../../images/Tv_Audio_Video images/tv5.3.png'
...
class Tv5 extends React.Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div className="flux_div_land">
          ...
          <h1 className="detail card-title">Rs 4,000<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text"> Headphone + mike </p>
