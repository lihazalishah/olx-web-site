...
import Tv11 from '../../images/Tv_Audio_Video images/tv8.1.jpg'
import Tv12 from '../../images/Tv_Audio_Video images/tv8.2.jpg'
import Tv13 from '../../images/Tv_Audio_Video images/tv8.3.jpg'
...
class Tv8 extends React.Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Electronic Video game</p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />BabuKhan342</h5>
