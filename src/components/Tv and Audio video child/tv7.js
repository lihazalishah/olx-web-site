...
import Tv11 from '../../images/Tv_Audio_Video images/tv7.1.jpg'
import Tv12 from '../../images/Tv_Audio_Video images/tv7.2.jpg'
import Tv13 from '../../images/Tv_Audio_Video images/tv7.3.jpg'
...
class Tv7 extends React.Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Condition : New/Used</p>
              <p className="card-text"><small className="text-muted">
                <hr />
                 <h5 className="card-title">Descriptions</h5>
                <ul>
                  <li>All electronic Items are available</li>
                  <li>Repairing available</li>
                </ul>
              </small></p>
          ...
          <h1 className="detail card-title">price: a/c to item<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text"> Electronic Items </p>
          <p className="card-text"><small>Main peco road Akber chowk Townshop karachi</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />FarmanKhan342</h5>
