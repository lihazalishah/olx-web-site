...
import Tv11 from '../../images/Tv_Audio_Video images/tv2.1.jpg'
import Tv12 from '../../images/Tv_Audio_Video images/tv2.2.jpg'
import Tv13 from '../../images/Tv_Audio_Video images/tv2.3.jpg'
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Size : 20inch</p>
          ...
          <h1 className="detail card-title">Rs 45,000<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />BilalHameed902</h5>
