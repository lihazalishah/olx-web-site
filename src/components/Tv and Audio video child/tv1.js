...
import Tv11 from '../../images/Tv_Audio_Video images/tv1.1.jpg'
import Tv12 from '../../images/Tv_Audio_Video images/tv1.2.jpg'
import Tv13 from '../../images/Tv_Audio_Video images/tv1.3.jpg'
...
class Tv1 extends React.Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div className="flux_div_land">
          ...
          <h1 className="detail card-title">Rs 55,000<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text"> LED </p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />IrfanKhan342</h5>
