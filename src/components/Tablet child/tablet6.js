...
import Tablet11 from '../../images/tablet images/tablet6.1.jpg'
import Tablet12 from '../../images/tablet images/tablet6.2.webp'
import Tablet13 from '../../images/tablet images/tablet6.3.webp'
...
class Tablet6 extends React.Component {
  render() {
    return (
      <div>
        <Header />
    ...
    <div className="carousel-item">
      <img style={{ height: "350px" }} src={Tablet13} className="d-block mt-2 w-100" alt="Image" />
            ...
            <h5 className="card-title">Detail</h5>
              <p className="card-text">Make : Hawaee</p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />NOOR SHOP</h5>
