...
import Tablet11 from '../../images/tablet images/tablet1.1.jpg'
    ...
    return (
      <div>
        ...
        <div className="flux_div_land">
            ...
            <div id="carouselExampleSlidesOnly" className="carousel slide container-sm" data-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active ">
                  <img   style={{ height: "350px" }} src={Tablet11} className="d-block mt-2 w-100" alt="Img" />
                </div>
              </div>
            </div>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Hassam654</h5>
