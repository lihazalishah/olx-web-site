...
import Tablet11 from '../../images/tablet images/tablet7.1.jpg'
import Tablet12 from '../../images/tablet images/tablet7.2.jpg'
import Tablet13 from '../../images/tablet images/tablet7.3.jpg'
...
class Tablet8 extends React.Component {
  render() {
    return (
      <div>
        <Header />
    ...
    <div className="carousel-item">
      <img style={{ height: "350px" }} src={Tablet13} className="d-block mt-2 w-100" alt="Image" />
            ...
            <h5 className="card-title">Detail</h5>
              <p className="card-text">Make : Q-Mobile</p>
          ...
          <h1 className="detail card-title">RS 8,000<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text"> Tablet </p>
          <p className="card-text"><small>SHOP-15, Islamabad, Islamabad Capital Territory</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Apna SHOP</h5>
