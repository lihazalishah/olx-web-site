...
import Tablet11 from '../../images/tablet images/tablet4.1.jpg'
import Tablet12 from '../../images/tablet images/tablet4.2.jpeg'
import Tablet13 from '../../images/tablet images/tablet4.3.webp'
...
class Tablet4 extends React.Component {
  render() {
    return (
      <div>
        <Header />
    ...
    <div className="carousel-item">
      <img style={{ height: "350px" }} src={Tablet13} className="d-block mt-2 w-100" alt="Image" />
            ...
            <h5 className="card-title">Detail</h5>
              <p className="card-text">Make : Samsung</p>
          ...
          <p className="card-text"><small>SHOP-A-15, Islamabad, Islamabad Capital Territory</small></p>
