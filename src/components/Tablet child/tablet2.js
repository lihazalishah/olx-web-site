...
import Tablet11 from '../../images/tablet images/tablet2.1.jpg'
import Tablet12 from '../../images/tablet images/tablet2.2.jpg'
import Tablet13 from '../../images/tablet images/tablet2.3.jpg'
...
class Tablet2 extends React.Component {
  render() {
    return (
      <div>
        <Header />
  ...
  <div className="carousel-inner">
    ...
    <div className="carousel-item">
      <img style={{ height: "350px" }} src={Tablet13} className="d-block mt-2 w-100" alt="Image" />
          ...
          <h1 className="detail card-title">RS 12,000<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text"> Tablet </p>
          <p className="card-text"><small>SHOP-A-40, Islamabad, Islamabad Capital Territory</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Furqan698</h5>
