...
import Tablet11 from '../../images/tablet images/tablet3.1.jpg'
import Tablet12 from '../../images/tablet images/tablet3.2.jpeg'
import Tablet13 from '../../images/tablet images/tablet3.3.jpg'
...
class Tablet3 extends React.Component {
  render() {
    return (
      <div>
        <Header />
    ...
    <div className="carousel-item">
      <img style={{ height: "350px" }} src={Tablet13} className="d-block mt-2 w-100" alt="Image" />
            ...
            <h5 className="card-title">Detail</h5>
              <p className="card-text">Make : Tablet</p>
          ...
          <h1 className="detail card-title">RS 25,000<ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          <p className="card-text"> Tablet </p>
          <p className="card-text"><small>SHOP-G-20, karachi, Karachi Defence Territory</small></p>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Irfan568</h5>
