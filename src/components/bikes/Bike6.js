...
import Bike11 from '../../images/bikes images/bike6.1.jpg';
import Bike12 from '../../images/bikes images/bike6.2.jpg';
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Color : Black</p>
            </div>
          ...
          <h1 className="detail card-title">PKR 30,000 <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Malik087</h5>
