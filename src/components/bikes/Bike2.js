...
import Bike11 from '../../images/bikes images/bike2.1.png';
import Bike12 from '../../images/bikes images/bike2.2.png';
import Bike13 from '../../images/bikes images/bike2.3.png';
...
class Bike2 extends React.Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Company :	Honda		</p>
          ...
          <h1 className="detail card-title">PKR 85,500  <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Ali907</h5>
