...
import Bike11 from '../../images/bikes images/bike5.1.jpg';
import Bike12 from '../../images/bikes images/bike5.2.jpg';
import Bike13 from '../../images/bikes images/bike5.3.jpg';
...
class Bike5 extends React.Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Body Type :	AMV		</p>
              <p className="card-text">Ad Ref #	273332</p>
          ...
          <h1 className="detail card-title">PKR 5lac  <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />Usman687</h5>
