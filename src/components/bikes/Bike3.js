...
import Bike11 from '../../images/bikes images/bike3.1.png';
import Bike12 from '../../images/bikes images/bike3.2.jpg';
import Bike13 from '../../images/bikes images/bike3.3.jpg';
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Ad Ref #	223432</p>
          ...
          <h1 className="detail card-title">PKR 5.3lac  <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />IkramAslam883</h5>
