...
import Bike11 from '../../images/bikes images/bike4.1.png';
import Bike12 from '../../images/bikes images/bike4.2.png';
...
class Bike4 extends React.Component {
  render() {
    return (
      <div>
        <Header />
        ...
        <div className="flux_div_land">
          ...
          <div className="card onclick_div mb-3 w-60">
            ...
            <div style={{ borderLeftColor: "black" }, { borderLeft: "1px" }} className="card-body">
              ...
              <p className="card-text">Body Type :	    WTV		</p>
              <p className="card-text">Ad Ref #	273132</p>
          ...
          <h1 className="detail card-title">PKR 2.3lac  <ShareOutlinedIcon style={{fontSize:30},{margin:20}}/><FavoriteBorderOutlinedIcon style={{fontSize:30}}/></h1>
          ...
          <h5 className="card-title"><AccountCircleOutlinedIcon style={{fontSize:60}} />SumairUmrani452</h5>
